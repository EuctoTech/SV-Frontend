...
export default Stu_Spo_StudentInvoice ;
...
//                       }}>INVOICE</h5>
//                              <div className='pt-1 px-3'>
//                       <h4 style={{fontFamily:'sans-serif'}}>Santhosha Vidhyalaya</h4>
...
//                           <p className='mb-0'style={{fontWeight: 'bold'}}>Grade</p>
//                           <p className='mb-0'style={{fontWeight: 'bold'}}>Section</p>
//                           <p className='mb-0'style={{fontWeight: 'bold'}}>RollNo</p>
//                           <p className='mb-0'style={{fontWeight: 'bold'}}>Group</p>
//                         </Col>
//                         <Col xs={10}>
//                           <p className='mb-0'>: {invoiceData.invoiceDetails && invoiceData.invoiceDetails.studentName}</p>
//                           <p className='mb-0 '>: {invoiceData.invoiceDetails && invoiceData.invoiceDetails.grade}</p>
//                           <p className='mb-0  '>: {invoiceData.invoiceDetails && invoiceData.invoiceDetails.section}</p>
//                           <p className='mb-0 '>: {invoiceData.invoiceDetails && invoiceData.invoiceDetails.rollNo}</p>
//                           <p className='mb-0 '>: {invoiceData.invoiceDetails && invoiceData.invoiceDetails.group}</p>
//                         </Col>
//                        </Row>
//                     </Col>
//                     <Col className='text-end pt-3'style={{textTransform: 'uppercase',}} xs={4}>
...
//           <td colSpan={4} style={{ wordWrap: 'break-word', fontSize: '12px', fontFamily: 'Arial, sans-serif', color: '#333' }}>
//             <strong>SCHOOL BANK DETAILS</strong><br />
//             Account Name: SANTHOSHA VIDHYALAYA<br />
//             Account No.: 1379 0200 0000 273<br />
//             IFSC Code: IOBA0001379<br />
//             Bank: Indian Overseas Bank<br />
//             Branch: Dohnavur
...
//           <tr>
//             <td colSpan={4} style={{ wordWrap: 'break-word', fontSize: '12px', fontFamily: 'Arial, sans-serif', color: '#333' }}>
//             <strong>  HOSTEL BANK DETAILS</strong><br />
//               Account Name: SANTHOSHA VIDHYALAYA - HOSTEL<br />
//               Account No.: <br />1379 0200 0000 272<br />
//               IFSC Code: IOBA0001379<br />
//               Bank: Indian Overseas Bank<br />
//               Branch: Dohnavur
//                             </td>
